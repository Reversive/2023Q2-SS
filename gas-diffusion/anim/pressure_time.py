...
plt.scatter(elapsed_time, left_pressure, label="Presión contenedor izquierdo", marker='x', s=10)
plt.scatter(elapsed_time, right_pressure, label="Presión contenedor derecho", marker='x', s=10)
